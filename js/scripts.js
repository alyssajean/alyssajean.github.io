...
$(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbydnnd2KaTXfCp33I138wvlOS3QWlVPzx-grp1c1xZ7NXbnnHyKTXF7MRdS9EzUTHcA/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 34.04811477661133, lng: -118.25558471679688};
...
function initBBSRMap() {
    var la_fiesta = {lat: 34.073814, lng: -118.240784};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
